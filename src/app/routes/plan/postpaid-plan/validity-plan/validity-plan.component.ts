...
// import { TablesKitchenSinkAddComponent } from './add/add.component';
...
export class ValidityPlanComponent implements OnInit {
  ...
  // add(value: any) {
  //   const dialogRef = this.dialog.originalOpen(TablesKitchenSinkAddComponent, {
  //     width: '600px',
  //     data: { record: value },
  //   });
