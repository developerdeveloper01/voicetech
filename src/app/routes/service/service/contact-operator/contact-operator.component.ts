...
import { TablesRemoteDataService } from '../contact-operator/remote-data.service';

@Component({
  selector: 'app-contact-operator',
  templateUrl: './contact-operator.component.html',
  styleUrls: ['./contact-operator.component.scss'],
  changeDetection: ChangeDetectionStrategy.OnPush,
  providers: [TablesRemoteDataService],
})
export class ContactOperatorComponent  implements OnInit {
