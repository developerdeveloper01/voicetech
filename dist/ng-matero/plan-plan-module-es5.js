(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["plan-plan-module"], {
    ...
    function jCtq(module, __webpack_exports__, __webpack_require__) {
      ...
      PlanModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_7__["ɵɵdefineNgModule"]({
        type: PlanModule
      });
      PlanModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_7__["ɵɵdefineInjector"]({
        ...
        function PricetominPlanComponent(dialog, dialogx, userService, cdr) {
          ...
          this.columns = [{
            ...
            buttons: [{
              ...
              tooltip: 'edit',
              click: function click(record) {
                return _this32.openEditDstNumber(record);
              }
            }, {
              color: 'warn',
              icon: 'delete',
        ...
        _createClass(PricetominPlanComponent, [{
          ...
          value: function _delete(value) {
            ...
            this.userService.deletenumber(value._id).subscribe(function (response) {
              ...
              _this35.dialogx.alert("You have deleted ".concat(value.dstnumber, "!"));
            }, function (error) {
              console.log('%cerror ips.component.ts line:254 ', 'color: red; display: block; width: 100%;', error);
            });
          }
          ...
          value: function submitdstnumber() {
            ...
            if (this.adddstnumber.valid) {
              this.userService.adddstnumber(this.adddstnumber.value).subscribe(function (response) {
                ...
                _this38.snackBar.open('DST Number Added Successfully!', '', {
                  duration: 2000
                });

                _this38.adddstnumber.reset(); //this.adddstnumber.markAsUntouched();
          ...
          value: function submitdstnumber() {
            ...
            if (this.editdstnumber.valid) {
              this.userService.editdstnumber(this.data.record._id, this.editdstnumber.value).subscribe(function (response) {
                ...
                _this41.snackBar.open('IP Edited Successfully!', '', {
                  duration: 2000
                });

                _this41.editdstnumber.reset();
              }, function (error) {
                console.log('%cerror ips.component.ts line:254 ', 'color: red; display: block; width: 100%;', error);
              });
            } else {
    ...
    function ypkg(module, __webpack_exports__, __webpack_require__) {
      ...
      var _postpaid_plan_postpaid_plan_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! ./postpaid-plan/postpaid-plan.component */
      "AzJj");
      /* harmony import */


      var _prepaid_plan_prepaid_plan_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      /*! ./prepaid-plan/prepaid-plan.component */
      "tWdt");
      /* harmony import */
      ...
      var routes = [{
        ...
        path: 'postpaid-plan',
        component: _postpaid_plan_postpaid_plan_component__WEBPACK_IMPORTED_MODULE_1__["PostpaidPlanComponent"]
      }];
      ...
      PlanRoutingModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵdefineNgModule"]({
        type: PlanRoutingModule
      });
      PlanRoutingModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵdefineInjector"]({
        imports: [[_angular_router__WEBPACK_IMPORTED_MODULE_0__["RouterModule"].forChild(routes)], _angular_router__WEBPACK_IMPORTED_MODULE_0__["RouterModule"]]
      });

      (function () {
        (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵsetNgModuleScope"](PlanRoutingModule, {
