...
/* harmony import */ var _cdr_cdr_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./cdr/cdr.component */ "hVHB");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/core */ "fXoL");




const routes = [{ path: 'cdr', component: _cdr_cdr_component__WEBPACK_IMPORTED_MODULE_1__["CdrComponent"] }];
...
ReportRoutingModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵdefineNgModule"]({ type: ReportRoutingModule });
ReportRoutingModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵdefineInjector"]({ imports: [[_angular_router__WEBPACK_IMPORTED_MODULE_0__["RouterModule"].forChild(routes)], _angular_router__WEBPACK_IMPORTED_MODULE_0__["RouterModule"]] });
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵsetNgModuleScope"](ReportRoutingModule, { imports: [_angular_router__WEBPACK_IMPORTED_MODULE_0__["RouterModule"]], exports: [_angular_router__WEBPACK_IMPORTED_MODULE_0__["RouterModule"]] }); })();
...
/* harmony import */ var _report_routing_module__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./report-routing.module */ "BQbq");
/* harmony import */ var _cdr_cdr_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./cdr/cdr.component */ "hVHB");
...
const COMPONENTS = [_cdr_cdr_component__WEBPACK_IMPORTED_MODULE_1__["CdrComponent"]];
const COMPONENTS_DYNAMIC = [_cdr_cdr_component__WEBPACK_IMPORTED_MODULE_1__["AddCdrFileFormComponent"], _cdr_cdr_component__WEBPACK_IMPORTED_MODULE_1__["EditCdrFileFormComponent"]];
class ReportModule {
}
ReportModule.ɵfac = function ReportModule_Factory(t) { return new (t || ReportModule)(); };
ReportModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵdefineNgModule"]({ type: ReportModule });
ReportModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵdefineInjector"]({ imports: [[_shared__WEBPACK_IMPORTED_MODULE_2__["SharedModule"], _report_routing_module__WEBPACK_IMPORTED_MODULE_0__["ReportRoutingModule"]]] });
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵsetNgModuleScope"](ReportModule, { declarations: [_cdr_cdr_component__WEBPACK_IMPORTED_MODULE_1__["CdrComponent"], _cdr_cdr_component__WEBPACK_IMPORTED_MODULE_1__["AddCdrFileFormComponent"], _cdr_cdr_component__WEBPACK_IMPORTED_MODULE_1__["EditCdrFileFormComponent"], _cdr_cdr_component__WEBPACK_IMPORTED_MODULE_1__["CdrComponent"]], imports: [_shared__WEBPACK_IMPORTED_MODULE_2__["SharedModule"], _report_routing_module__WEBPACK_IMPORTED_MODULE_0__["ReportRoutingModule"]] }); })();
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "CdrComponent", function() { return CdrComponent; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "AddCdrFileFormComponent", function() { return AddCdrFileFormComponent; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "EditCdrFileFormComponent", function() { return EditCdrFileFormComponent; });
...
/* harmony import */ var _ng_matero_extensions_data_grid__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! @ng-matero/extensions/data-grid */ "hGDI");
...
function CdrComponent_mat_option_19_Template(rf, ctx) { if (rf & 1) {
...
function CdrComponent_ng_template_26_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](0);
} if (rf & 2) {
    const row_r9 = ctx.$implicit;
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtextInterpolate1"](" ", row_r9.uuid, " ");
} }
function CdrComponent_ng_template_28_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](0);
} if (rf & 2) {
...
class CdrComponent {
    constructor(dialog, dialogx, userService, cdr, fb) {
        this.dialog = dialog;
    ...
    ngOnInit() {
        this.filteredOptions = this.myControl.valueChanges.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_8__["startWith"])(''), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_8__["map"])(value => this._filter(value)));
    ...
    getallcdrreport() {
        var num = 1;
        this.userService.allcdrreport().subscribe((response) => {
            console.log('%cips.component.ts line:248 response', 'color: #26bfa5;', response);
    ...
    searchcdrreport() {
        ...
        this.userService.searchreportbynumber(someform).subscribe((response) => {
            console.log('%cips.component.ts line:248 response', 'color: #26bfa5;', response);
            this.list = response.data;
            this.total = response.data.length;
            this.isLoading = false;
    ...
    submitsearch() {
        ...
        this.userService.searchreportbynumber(this.searchform.value).subscribe((response) => {
            console.log('%cips.component.ts line:248 response', 'color: #26bfa5;', response);
            this.list = response.data;
            this.total = response.data.length;
            this.isLoading = false;
    ...
    expansion(e) {
        ...
        this.userService.getsinglerecording(date, caller_id_number, destination_number, uuid).subscribe(data => {
            console.log(data);
        }, error => {
            console.log(error);
        });
...
CdrComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: CdrComponent, selectors: [["app-cdr"]], viewQuery: function CdrComponent_Query(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("page", function CdrComponent_Template_mtx_grid_page_25_listener($event) { return ctx.pagechangeevent($event); })("sortChange", function CdrComponent_Template_mtx_grid_sortChange_25_listener($event) { return ctx.changeSort($event); })("rowSelectionChange", function CdrComponent_Template_mtx_grid_rowSelectionChange_25_listener($event) { return ctx.rowselection($event); })("expansionChange", function CdrComponent_Template_mtx_grid_expansionChange_25_listener($event) { return ctx.expansion($event); })("cellSelectionChange", function CdrComponent_Template_mtx_grid_cellSelectionChange_25_listener($event) { return ctx.cellselection($event); })("rowClick", function CdrComponent_Template_mtx_grid_rowClick_25_listener($event) { return ctx.verNotificacion($event); });
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
...
AddCdrFileFormComponent.ɵfac = function AddCdrFileFormComponent_Factory(t) { return new (t || AddCdrFileFormComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormBuilder"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](app_user_service__WEBPACK_IMPORTED_MODULE_5__["UserService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_material_snack_bar__WEBPACK_IMPORTED_MODULE_4__["MatSnackBar"])); };
AddCdrFileFormComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: AddCdrFileFormComponent, selectors: [["add-cdr-form"]], decls: 46, vars: 1, consts: [["mat-dialog-title", ""], [1, "row"], [1, "col-lg-12"], [2, "width", "100%"], ["matInput", "", "placeholder", "Plan Title", "formControlName", "", "required", ""], ["matInput", "", "placeholder", "Plan Price", "formControlName", "", "required", ""], ["required", "", "formControlName", "gender", "required", ""], ["value", "1"], ["value", "2"], ["mat-raised-button", "", "mat-dialog-close", ""], ["mat-raised-button", "", "mat-dialog-close", "", "color", "primary", "cdkFocusInitial", "", "type", "submit", 3, "disabled"]], template: function AddCdrFileFormComponent_Template(rf, ctx) { if (rf & 1) {
