...
MonitoringComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: MonitoringComponent, selectors: [["app-monitoring"]], decls: 59, vars: 0, consts: [[1, "bg-blue-600"], [1, "m--16"], ["label", "Aero"], [1, "m-16"], [1, "row"], [1, "col-lg-12", "align-center"], [1, "col-lg-8"], [1, "col-lg-4"], ["label", "OLA"], ["label", "OLATFN"], ["label", "Schoolivr"]], template: function MonitoringComponent_Template(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](0, "page-header", 0);
